package en.nayphilim.turnbasedrpg.net;

//this class handles the login of the user and manages the packets sent by the client to the server
//this is an example of a complex client-server model
...
import en.nayphilim.turnbasedrpg.net.packets.Packet;
import en.nayphilim.turnbasedrpg.net.packets.Packet.PacketTypes;
import en.nayphilim.turnbasedrpg.net.packets.Packet00Login;
import en.nayphilim.turnbasedrpg.net.packets.Packet01Disconnect;
